...
function savePassword(password) {
    var _a;
    var savedPasswords = JSON.parse((_a = localStorage.getItem("passwords")) !== null && _a !== void 0 ? _a : "[]");
...
function displaySavedPasswords() {
    ...
    var listOfPasswords = savedPasswords
        ...
        return "<div><span>".concat(index + 1, "</span> ").concat(escapeHTML(password), "</div>");
    })
        .join("");
